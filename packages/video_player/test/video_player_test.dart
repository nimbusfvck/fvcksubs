...
void main() {
  ...
  group('VideoPlayerController', () {
    ...
    group('seekTo', () {
      ...
      test('does not clamp a live seek to the indefinite duration', () async {
        final controller = VideoPlayerController.networkUrl(
          _localhostUri,
          isLive: true,
        );
        ...
        expect(await controller.position, const Duration(seconds: 100));
      });
    });
    ...
    group('VideoPlayerValue', () {
      test('uninitialized()', () {
        ...
        expect(uninitialized.seekable, isEmpty);
