...
class VideoPlayerValue {
  ...
  const VideoPlayerValue({
    ...
    this.seekable = const <platform_interface.DurationRange>[],
  ...
  /// The ranges that can currently be sought in the media.
  ///
  /// For live AVFoundation streams this is the moving seekable window, not
  /// the amount of data that has already been read ahead.
  final List<platform_interface.DurationRange> seekable;
  ...
  VideoPlayerValue copyWith({
    ...
    List<platform_interface.DurationRange>? seekable,
    bool? isInitialized,
    bool? isPlaying,
    bool? isLooping,
    bool? isBuffering,
  ...
  bool operator ==(Object other) =>
      ...
      other is VideoPlayerValue &&
          ...
          listEquals(seekable, other.seekable) &&
...
class VideoPlayerController extends ValueNotifier<VideoPlayerValue> {
  ...
  /// must be a configuration supported by the current platform implementation.
  /// DRM is supported only for network sources.
  ...
  ///
  /// Only set for network sources; it is always null for asset, file, and
  /// content URI sources.
  ...
  /// Whether this source is an unbounded live timeline.
  ///
  /// Live AVFoundation items often report an indefinite duration. In that
  /// case the platform still accepts seeks inside its seekable window, so the
  /// controller must not clamp them to the placeholder duration.
  final bool isLive;
  ...
  Future<void> play() async {
    if (!isLive && value.position == value.duration) {
  ...
  Future<void> seekTo(Duration position) async {
    ...
    if (!isLive && position > value.duration) {
  ...
  void _updatePosition(Duration position) {
    ...
    value = value.copyWith(
      ...
      isCompleted: !isLive && position == value.duration,
    );
  }
