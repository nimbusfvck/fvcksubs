...
class VideoEvent {
  ...
  /// [rotationCorrection], [buffered], and [seekable] arguments can be null.
  ...
  /// Time ranges that can currently be sought in the media.
  ///
  /// This is distinct from [buffered]: a live AVPlayer item can expose a
  /// moving seekable window while its read-ahead buffer is larger or empty.
  /// Only used if [eventType] is [VideoEventType.bufferingUpdate].
  final List<DurationRange>? seekable;
...
enum VideoEventType {
  ...
  /// Updated information on the buffering and seekable ranges.
  bufferingUpdate,
