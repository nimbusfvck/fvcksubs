...
/// Called when the platform reports the currently seekable timeline window.
///
/// The array elements are two-element arrays, each containing the start and
/// duration, in milliseconds, of a seekable region.
