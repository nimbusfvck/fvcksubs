...
class LegacyUserMediaState extends Equatable {
  /// Creates a record.
  const LegacyUserMediaState({
    required this.ref,
    required this.item,
    this.favorite = false,
    this.progress,
  ...
  /// Builds a [LegacyUserMediaState] from decoded JSON.
  factory LegacyUserMediaState.fromJson(Map<String, Object?> json) =>
