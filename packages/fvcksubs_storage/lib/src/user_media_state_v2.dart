...
class UserMediaStateV2 extends Equatable {
  /// Creates a persisted item snapshot.
  const UserMediaStateV2({
    required this.item,
    this.favorite = false,
    this.progress,
    this.lastWatched,
  ...
  factory UserMediaStateV2.fromJson(Map<String, Object?> json) {
