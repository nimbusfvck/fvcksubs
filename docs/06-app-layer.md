...
| Picture in Picture preference | whether leaving the player may enter PiP | Global and persistent. It defaults to enabled for existing users; disabling it makes Back close the player normally without requesting native PiP. |
